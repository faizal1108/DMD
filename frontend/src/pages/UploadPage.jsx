...
const UploadPage = () => {
  return (
        <>
            <div className="p-4"> 
                <div className="flex items-center gap-3  border border-[#dbe4ff] bg-[#eef2ff] px-5 py-4 rounded-lg">
                    <div className=" flex-shrink-0">
                    <svg xmlns="http://www.w3.org/2000/svg" height="20" width="20" viewBox="0 -960 960 960" fill="#2563eb">
                    ...
                    <p className="text-[15px] leading-8 text-[#2553EB]">
